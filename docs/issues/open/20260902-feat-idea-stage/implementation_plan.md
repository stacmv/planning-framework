...
- [ ] TC-002 passes
- [ ] TC-007 passes
- [ ] Ни один ключ подшага не обслуживает два разных вопроса; возобновление
      однозначно определяет и вопрос, и происхождение intake
- [ ] Нет состояния, в котором открытого маркера не существует ни в одном
      черновике
...
- [ ] TC-032 passes
- [ ] TC-017 passes
- [ ] Ни в одном из четырёх стартовых состояний final-gate подтверждение не
...
- [ ] TC-013 passes
- [ ] TC-032 passes
- [ ] Для каждого ассерта названа и проверена мутация, которая его краснит
- [ ] Сьют краснеет на регрессиях CR-020 и CR-021, которые текущая версия
      пропустила
