...
**Acceptance Criteria:**
- [ ] TC-032 passes
- [ ] Закрытие спайка со сторонней ветки не оставляет коммитов на ней
...
- [ ] Условие включения адаптера не ссылается на `roles.*.write` ни в одном
...
- [ ] TC-013 passes
- [ ] TC-029 — manual, per test_plan.md
- [ ] Схема состояния замкнута: перечислены допустимые `stage-key`, подшаг,
...
- [ ] TC-002 passes
- [ ] TC-029 — manual, per test_plan.md
- [ ] Выбор между (а) и (б) сделан и зафиксирован в устанавливаемом скилле,
