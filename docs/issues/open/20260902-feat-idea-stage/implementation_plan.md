...
- [ ] TC-002 passes
- [ ] TC-007 passes
- [ ] Ни одно утверждение контракта не противоречит описанному в нём же пути
- [ ] Прерывание посреди разворота каркаса возобновляется однозначно
...
- [ ] TC-032 passes
- [ ] TC-017 passes
- [ ] Все восемь клеток «ветка × маркер» описаны, и ни в одной подтверждение
      не теряется и не блокируется
- [ ] Латентность (достижимо только вне текущего скоупа) названа явно
...
- [ ] TC-013 passes
- [ ] TC-032 passes
- [ ] Инверсия условия (`!= claude` → `== claude`, clean↔dirty) краснит сьют
- [ ] Манифест мутаций лежит в репозитории и прогоняется раннером, то есть
