...
**Acceptance Criteria:**
- [ ] TC-014 passes — включая новую ветку: задача `code`, маппящаяся на кейс без строки в Status Tracker, блокирует гейт
- [ ] TC-013 passes — включая fail-closed на дублирующейся строке кейса с расходящимся `Type`
- [ ] TC-015 passes — обратное направление не затронуто, самопроверка направленности зелёная
