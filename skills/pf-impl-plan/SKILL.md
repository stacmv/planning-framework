...
**Resolve role** for the `implementation_plan` key per `<PF_SKILL_ROOT>/pf-roles/SKILL.md` (§4's fallback order), before deciding how to produce the document.
