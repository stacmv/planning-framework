...
**Project:** planning-with-user-files
...
- `planning/implementation-plan.md` - Roadmap & active issues
- `planning/session-log.md` - Session timeline
- `planning/decisions.md` - Architectural decisions
- `planning/issues/open/` - Active issues
- `planning/issues/closed/` - Completed issues
...
2. **`planning/implementation-plan.md`** - Current roadmap & active issues
3. **`planning/session-log.md`** (last 20 lines) - Recent activity

### Step 2: If Working on an Issue
**Read issue files in order:**
1. `planning/issues/open/{issue-id}/prompt.md` - Original request
2. `planning/issues/open/{issue-id}/analysis.md` - Understanding & approach
3. `planning/issues/open/{issue-id}/implementation-plan.md` - Task breakdown
4. `planning/issues/open/{issue-id}/session-log.md` - Progress history
5. `planning/issues/open/{issue-id}/decisions.md` - (if exists) Issue decisions

### Step 3: Read Project Context
1. **`planning/decisions.md`** - Architectural decisions
...
```bash
# Create issue folder
mkdir planning/issues/open/YYYYMMDD-type-slug/
...
# 2. Move issue folder
mv planning/issues/open/YYYYMMDD-type-slug planning/issues/closed/

# 3. Update global session-log.md
echo "[Agent] ✓ [issue-id](../issues/closed/issue-id) - Description" >> planning/session-log.md
...
- [ ] Format: `[Agent] 2025-01-01: Description`
- [ ] Commit changes
...
2. See `planning/MIGRATION-GUIDE.md` for details
3. Archive old v1.0 files in `planning/v1.0-archive/`
...
- `planning/FRAMEWORK.md` - Complete v2.0 guide
- `planning/QUICKSTART.md` - 5-minute setup guide
- `planning/MIGRATION-GUIDE.md` - v1.0 to v2.0 migration

**Templates:**
- `planning/templates/issue/` - Issue file templates
- `planning/templates/global/` - Global planning templates
- `planning/templates/config/` - Config file templates
